...
class iPhoneXXSmainpage1 extends StatelessWidget {
  iPhoneXXSmainpage1({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(48.0, 242.66),
            child: Text(
              '검색어를 입력해주세요.',
              style: TextStyle(
                fontFamily: 'BM JUA_TTF',
                fontSize: 18,
                color: const Color(0x80f29f58),
          ...
          Transform.translate(
            offset: Offset(-5.3, 56.36),
            child: Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(148.3, 479.64),
                  child: Container(
                    width: 90.0,
                    height: 39.0,
                    decoration: BoxDecoration(
                      borderRadius:
                          BorderRadius.all(Radius.elliptical(45.0, 19.5)),
